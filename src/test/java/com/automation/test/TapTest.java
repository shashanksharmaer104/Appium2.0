...
public class TapTest {
    ...
    @Test
    public void AndroidTapTest() throws MalformedURLException, InterruptedException {
    ...
    @Test
    public void IOSTapTest() throws MalformedURLException, InterruptedException {
        ...
        WebElement element = driver.findElement(By.name("store item text"));
